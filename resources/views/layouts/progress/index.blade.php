		...
		<nav id="sidebar">
			...
			<div class="sidebar-content">
				...
				<div class="content-side content-side-full">
						<ul class="nav-main">
								<li>
										<a href="{{ route('projects.index') }}"><i class="si si-note"></i><span class="sidebar-mini-hide">All Projects</span></a>
								</li>
								<li>
										<a href="{{ route('projects.show', $proj_id) }}"><i class="fa fa-info fa-lg"></i><span class="sidebar-mini-hide">Project Details</span></a>
								</li>
								<li>
										<a href="{{ route('pp.index',$proj_id) }}"><i class="si si-arrow-right"></i><span class="sidebar-mini-hide">Pra Preparation</span></a>
								</li>
								<li>
										<a href="{{ route('pr.index',$proj_id) }}"><i class="si si-arrow-right"></i><span class="sidebar-mini-hide">Preparation</span></a>
								</li>
								<li>
										<a href="{{ route('fa.index',$proj_id) }}"><i class="si si-arrow-right"></i><span class="sidebar-mini-hide">Fabrication</span></a>
								</li>
								<li>
										<a href="{{ route('sa.index',$proj_id) }}"><i class="si si-arrow-right"></i><span class="sidebar-mini-hide">Sub Assembly</span></a>
								</li>
								<li>
										<a href="{{ route('as.index',$proj_id) }}"><i class="si si-arrow-right"></i><span class="sidebar-mini-hide">Assembly</span></a>
								</li>
								<li>
										<a href="{{ route('er.index',$proj_id) }}"><i class="si si-arrow-right"></i><span class="sidebar-mini-hide">Erection</span></a>
								</li>
								<li>
										<a href="{{ route('reports.index',$proj_id) }}"><i class="si si-doc"></i><span class="sidebar-mini-hide">Reports</span></a>
								</li>
						</ul>
				</div>
				<!-- END Side Navigation -->
